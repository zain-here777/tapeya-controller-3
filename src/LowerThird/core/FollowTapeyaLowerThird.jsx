...
/**
 * FollowTapeya lower third — Tapeya logo + follow CTA on batsman panel color.
 *
 * @param {Object} props
 ...
 */
export default function FollowTapeyaLowerThird({
  match,
  baseConfig,
  ...
  const {
    headline = "FOR BALL BY BALL UPDATES FOLLOW",
    site = "tapeya.com",
          ...
          <div className="relative z-[1] flex min-w-0 flex-1 flex-col bg-transparent">
            ...
            {site ? (
              <div className="flex h-[calc(83px*var(--cs))] min-h-0 flex-1 items-center border-t border-divider bg-transparent px-[calc(28px*var(--cs))]">
                <span className="ctrl-t-follow-tapeya-site text-white">
                  {site}
                </span>
              </div>
            ) : null}
