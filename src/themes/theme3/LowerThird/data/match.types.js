/**
 * Broadcast match payload for lower-third scorecard controllers.
 * Pass this object as the `match` prop — typically from your scoring feed / API.
 *
 ...
 * @property {"gold"|"red"} [theme] - Fallback crest palette
 ...
 * @property {number} [lastOverRuns] - Runs scored in the previous over (PreviousOver)
 *
 ...
 * @property {MatchStat[]} [stats] - Multiple stat slots (e.g. To Win | Balls); takes precedence over `stat`
