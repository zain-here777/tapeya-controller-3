...
export default function NameFSCore({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex h-full w-full items-center justify-center gap-[calc(12px*var(--t5-scale))] box-border px-[calc(48px*var(--t5-scale))] py-[calc(40px*var(--t5-scale))] motion-safe:animate-soft-in motion-reduce:animate-none">
        <div className="relative flex h-full min-h-0 w-[min(42%,calc(620px*var(--t5-scale)))] shrink-0 items-center justify-center overflow-hidden">
          {photoUrl ? (
            ...
            <div className="flex h-full w-full items-center justify-center">
              <span className="text-[calc(68px*var(--t5-scale))] font-extrabold uppercase leading-[0.95] tracking-[calc(1.5px*var(--t5-scale))] text-white/40">
                {(lastName || "?").slice(0, 1)}
              </span>
            </div>
          )}
        ...
        <div className="flex w-[min(48%,calc(520px*var(--t5-scale)))] min-w-0 shrink-0 flex-col items-start justify-center gap-[calc(28px*var(--t5-scale))]">
          ...
          >
            <div className="flex flex-col gap-[calc(8px*var(--t5-scale))] leading-none">
              {firstName ? (
                <span className="text-[calc(28px*var(--t5-scale))] font-semibold uppercase leading-[1.05] tracking-[calc(2px*var(--t5-scale))] text-[#f8fafc]">
                  {firstName}
                </span>
              ) : null}
              <span className="text-[calc(68px*var(--t5-scale))] font-extrabold uppercase leading-[0.95] tracking-[calc(1.5px*var(--t5-scale))] text-[#f8fafc]">
                {lastName}
              </span>
            </div>
            ...
            <div className="flex flex-col gap-[calc(10px*var(--t5-scale))]">
              {teamCode ? (
                <span className="text-[calc(18px*var(--t5-scale))] font-bold uppercase leading-[1.1] tracking-[calc(2px*var(--t5-scale))] text-[#7dd3fc]">
                  {teamCode}
                </span>
              ) : null}
              {role ? (
                <span className="text-[calc(24px*var(--t5-scale))] font-bold uppercase leading-[1.15] tracking-[calc(1.2px*var(--t5-scale))] text-[#f8fafc]">
                  {role}
                </span>
              ) : null}
              {subtitle ? (
                <span className="text-[calc(18px*var(--t5-scale))] font-medium leading-[1.2] tracking-[calc(0.4px*var(--t5-scale))] text-[#f8fafc]/[0.72]">
                  {subtitle}
                </span>
              ) : null}
            </div>
