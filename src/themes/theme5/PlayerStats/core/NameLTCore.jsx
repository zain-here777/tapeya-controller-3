  ...
  return (
    <div className="w-full shrink-0 select-none font-montserrat motion-safe:animate-t5-rise-soft motion-reduce:animate-none">
      <div className="mb-[calc(45px*var(--t5-scale))] w-full px-[calc(210px*var(--t5-scale))]">
        ...
        >
          <div className="relative z-[1] flex min-w-0 flex-1 flex-col justify-center px-[calc(28px*var(--t5-scale))]">
            <div className="flex min-w-0 flex-col gap-[calc(8px*var(--t5-scale))] leading-none">
              <span className="motion-safe:animate-soft-in motion-reduce:animate-none text-[calc(36px*var(--t5-scale))] font-bold uppercase leading-[1.05] tracking-[calc(1.2px*var(--t5-scale))] text-[#f8fafc]">
                {name}
              </span>
              {role ? (
                <span className="motion-safe:animate-soft-in motion-reduce:animate-none text-[calc(18px*var(--t5-scale))] font-semibold uppercase leading-[1.1] tracking-[calc(1.2px*var(--t5-scale))] text-[#f8fafc]/[0.88]" style={{ animationDelay: "80ms" }}>
                  {role}
                </span>
              ) : null}
            </div>
