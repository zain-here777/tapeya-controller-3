/**
 * Theme 5 broadcast motion helpers — Tailwind animation class strings.
 * Prefer these over ad-hoc animation classes for consistency.
 */

export const T4_MOTION = {
  fadeUp: "motion-safe:animate-t5-fade-up motion-reduce:animate-none",
  fadeIn: "motion-safe:animate-t5-fade-in motion-reduce:animate-none",
  scaleIn: "motion-safe:animate-t5-scale-in motion-reduce:animate-none",
  slideLeft: "motion-safe:animate-t5-slide-left motion-reduce:animate-none",
  slideRight: "motion-safe:animate-t5-slide-right motion-reduce:animate-none",
  riseSoft: "motion-safe:animate-t5-rise-soft motion-reduce:animate-none",
