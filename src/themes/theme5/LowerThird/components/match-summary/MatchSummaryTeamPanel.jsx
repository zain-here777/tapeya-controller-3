...
export default function MatchSummaryTeamPanel({ team, backgroundColor, side }) {
  ...
  return (
    <div
      className={`flex min-w-0 flex-1 items-center gap-[calc(24px*var(--t5-scale))] px-[calc(28px*var(--t5-scale))] ${
        isStart ? "" : "flex-row-reverse"
      }`}
      style={{ backgroundColor }}
    >
      <span
        className={`min-w-0 flex-1 truncate text-[calc(28px*var(--t5-scale))] font-bold uppercase leading-none text-white ${
