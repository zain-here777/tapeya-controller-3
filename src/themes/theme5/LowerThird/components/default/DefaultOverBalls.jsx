...
const SIZE_STYLES = {
  md: {
    ball: "h-[calc(42px*var(--t5-scale))] min-w-[calc(42px*var(--t5-scale))] px-[calc(6px*var(--t5-scale))] text-[calc(14px*var(--t5-scale))]",
    fixed: "w-[calc(42px*var(--t5-scale))]",
    wide: "min-w-[calc(52px*var(--t5-scale))] text-[calc(12px*var(--t5-scale))]",
    dot: "h-[calc(8px*var(--t5-scale))] w-[calc(8px*var(--t5-scale))]",
    gap: "gap-[calc(8px*var(--t5-scale))]",
  },
  sm: {
    ball: "h-[calc(32px*var(--t5-scale))] min-w-[calc(32px*var(--t5-scale))] px-[calc(4px*var(--t5-scale))] text-[calc(12px*var(--t5-scale))]",
    fixed: "w-[calc(32px*var(--t5-scale))]",
    wide: "min-w-[calc(40px*var(--t5-scale))] text-[calc(11px*var(--t5-scale))]",
    dot: "h-[calc(7px*var(--t5-scale))] w-[calc(7px*var(--t5-scale))]",
    gap: "gap-[calc(5px*var(--t5-scale))]",
  },
};
