...
/**
 * Theme 5 right panel for Current Partnership — title/stat columns + bowling-side team code.
  ...
  return (
    ...
    >
      <Last30BallsCard
        ...
        stats={stats}
        statLabelClassName="whitespace-nowrap text-[calc(18px*var(--t5-scale))] font-bold uppercase tracking-wide"
