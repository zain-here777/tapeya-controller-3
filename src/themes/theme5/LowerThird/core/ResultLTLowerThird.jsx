...
/**
 * Theme 5 Result LT — result pill above bar; crest | team | VS | team | crest.
 * Same visual shell as IntroLT / TossLT.
 *
 * @param {Object} props
...
export default function ResultLTLowerThird({
  ...
  const result = match.result ?? config.defaultResult ?? "TIE";
  ...
  return (
    <div className="w-full shrink-0 select-none font-montserrat">
      <div className="mb-[calc(45px*var(--t5-scale))] flex w-full flex-col items-center gap-[calc(8px*var(--t5-scale))] px-[calc(210px*var(--t5-scale))]">
        {result ? <MatchSummaryTitle title={result} /> : null}
