...
/**
 * Theme 5 This Over lower third — Default shell without CRR; full over-ball strip.
 *
 * @param {Object} props
 ...
 */
export default function ThisOverLowerThird({
  match,
  baseConfig,
  ...
  const showFullOverBalls = config.bowlerPanel?.showFullOverBalls !== false;
