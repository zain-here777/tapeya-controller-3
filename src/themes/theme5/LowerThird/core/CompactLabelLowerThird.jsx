...
/**
 * Theme 5 compact label bar — MiniScorecard shell with text only.
  ...
  return (
    <div className="w-full shrink-0 select-none font-montserrat">
      <div className="flex h-[var(--t5-bar-height)] w-full items-stretch">
        <div
          className="flex h-full shrink-0 items-center pl-[calc(20px*var(--t5-scale))] pr-[calc(48px*var(--t5-scale))] shadow-[0_-2px_10px_rgba(0,0,0,0.12)]"
