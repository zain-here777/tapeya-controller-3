...
import Last12BallsRightPanel from "../components/last-12-balls/Last12BallsRightPanel.jsx";

/**
 * Theme 5 Last 12 Balls lower third — Default shell without CRR; last-12 strip on the right.
 *
 * @param {Object} props
 ...
 */
export default function Last12BallsLowerThird({
  match,
  baseConfig,
