...
/**
 * Theme 5 shared action banner — broadcast celebration layout on FST plate color.
 *
 * @param {Object} props
...
export default function ActionBannerLowerThird({
  ...
  if (layout === "broadcast") {
    return (
      <div className="w-full shrink-0 select-none font-montserrat">
        <div className="relative flex h-[var(--t5-bar-height)] w-full items-stretch overflow-visible shadow-[0_-2px_10px_rgba(0,0,0,0.25)]">
  ...
  return (
    <div className="w-full shrink-0 select-none font-montserrat">
      <div
        className="t5-broadcast-bar relative flex h-[var(--t5-bar-height)] w-full items-center overflow-hidden shadow-[0_-2px_10px_rgba(0,0,0,0.12)]"
