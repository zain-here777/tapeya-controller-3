...
/**
 * Theme 5 Toss LT — toss result pill above bar; crest | team | VS | team | crest.
 * Same visual shell as IntroLT.
 *
 * @param {Object} props
...
export default function TossLTLowerThird({
  ...
  const tossResult =
    match.tossResult ??
    config.defaultTossResult ??
    "ENGLAND WON THE TOSS AND ELECTED TO BAT FIRST";

  return (
    <div className="w-full shrink-0 select-none font-montserrat">
      <div className="mb-[calc(45px*var(--t5-scale))] flex w-full flex-col items-center gap-[calc(8px*var(--t5-scale))] px-[calc(210px*var(--t5-scale))]">
        {tossResult ? <MatchSummaryTitle title={tossResult} /> : null}

        <div className="flex h-[var(--t5-bar-height)] w-full items-stretch overflow-hidden shadow-[0_-2px_10px_rgba(0,0,0,0.12)]">
          <DefaultTeamEndCap
            team={match.teamA}
            barSide="left"
