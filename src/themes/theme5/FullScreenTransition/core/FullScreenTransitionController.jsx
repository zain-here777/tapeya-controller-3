...
/**
 * Theme 5 Full Screen Transition — Default lower third + centered action overlay.
 *
 * @param {Object} props
...
export default function FullScreenTransitionController({
  ...
  return (
    <div className="t5-fst-page select-none font-montserrat">
      ...
      <div className="t5-fst-scorecard">
        <DefaultLowerThird
          match={match}
