...
function StatCol({ topLabel, bottomLabel, value }) {
  return (
    <div
      className={`${t4Motion("scaleIn")} flex min-w-[calc(180px*var(--t5-scale))] flex-col items-center gap-[calc(18px*var(--t5-scale))]`}
    >
...
/** Need target — chase graphic (Theme 3 height / proportions, Theme 5 look). */
  ...
  return (
    <FullScreenPageShell>
      ...
      >
        ...
        <div
          className={`${t4Motion("riseSoft")} relative mx-auto my-auto flex w-full ${NEED_FS_CARD_MAX_W} flex-col items-center pb-[calc(28px*var(--t5-scale))]`}
          style={t4StaggerStyle(1, 120)}
        >
          <div
            className={`relative flex ${NEED_FS_CARD_MIN_H} w-full flex-col items-center justify-center gap-[calc(48px*var(--t5-scale))] rounded-[calc(14px*var(--t5-scale))] border border-white/20 px-[calc(56px*var(--t5-scale))] pb-[calc(72px*var(--t5-scale))] pt-[calc(56px*var(--t5-scale))] shadow-[0_0_calc(40px*var(--t5-scale))_rgba(0,0,0,0.35)]`}
            style={cardStyle}
          >
            {title ? (
              <h2 className="relative z-[1] text-center text-[calc(28px*var(--t5-scale))] font-bold uppercase tracking-[calc(1.5px*var(--t5-scale))] text-[#f8fafc]">
                {title}
              </h2>
            ) : null}
            <div className="relative z-[1] flex w-full items-start justify-center gap-[calc(72px*var(--t5-scale))]">
          ...
          {wicketsLabel ? (
            <div className="absolute bottom-0 left-1/2 z-[2] flex min-w-[calc(280px*var(--t5-scale))] -translate-x-1/2 items-center justify-center rounded-[calc(10px*var(--t5-scale))] bg-gradient-to-b from-[#7dd3fc] to-[#0ea5e9] px-[calc(28px*var(--t5-scale))] py-[calc(14px*var(--t5-scale))] shadow-[0_calc(6px*var(--t5-scale))_calc(16px*var(--t5-scale))_rgba(0,0,0,0.35)]">
              <span className="text-[calc(22px*var(--t5-scale))] font-bold uppercase tracking-[calc(1.5px*var(--t5-scale))] text-[#0b1220]">
                {wicketsLabel}
              </span>
            </div>
          ) : null}
