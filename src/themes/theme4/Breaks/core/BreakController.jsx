...
/**
 * Shared Theme 4 full-page Break shell.
...
export default function BreakController({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden bg-[var(--t4-surface)] select-none font-montserrat">
      <BreakBackground />

      <div className="relative z-[1] flex w-full max-w-[calc(1280px*var(--t4-scale))] flex-col items-center gap-[calc(56px*var(--t4-scale))] box-border px-[calc(48px*var(--t4-scale))] py-[calc(64px*var(--t4-scale))]">
        <header
          className={`${t4Motion("fadeUp")} flex flex-col items-center gap-[calc(12px*var(--t4-scale))] text-center`}
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-[calc(48px*var(--t4-scale))] max-[900px]:gap-[calc(32px*var(--t4-scale))]">
        ...
        <div
          className={`${t4Motion("riseSoft")} flex min-w-[calc(280px*var(--t4-scale))] shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#0ea5e9] to-[#0369a1] px-[calc(40px*var(--t4-scale))] py-[calc(18px*var(--t4-scale))] shadow-[0_calc(8px*var(--t4-scale))_calc(28px*var(--t4-scale))_rgba(14,165,233,0.35),inset_0_1px_0_rgba(255,255,255,0.25)]`}
          style={t4StaggerStyle(4, 220, 0)}
        >
          <span className="text-[calc(28px*var(--t4-scale))] font-bold uppercase leading-none tracking-[calc(2px*var(--t4-scale))] text-[#f8fafc]">
            {statusLabel}
          </span>
        </div>
      </div>
