...
const ROW_GRID =
  "grid w-full grid-cols-[minmax(calc(140px*var(--t4-scale)),1.4fr)_repeat(5,minmax(0,1fr))] items-center gap-[calc(6px*var(--t4-scale))]";
        ...
        <div className="flex items-center gap-[calc(48px*var(--t4-scale))]">
          ...
          <div className="flex min-w-0 max-w-[calc(780px*var(--t4-scale))] flex-1 flex-col gap-[calc(16px*var(--t4-scale))]">
            ...
            <div className="flex w-full flex-col gap-[calc(8px*var(--t4-scale))]">
              <div className={`${ROW_GRID} shrink-0 px-[calc(18px*var(--t4-scale))]`}>
                <span className="block" aria-hidden="true" />
                {BOWLING_COLUMNS.map((col) => (
                  <span
                    key={col.key}
                    className="text-center text-[calc(16px*var(--t4-scale))] font-semibold uppercase leading-[1.1] tracking-[calc(0.6px*var(--t4-scale))] text-[#f8fafc]"
                  >
                    {col.label}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-[calc(8px*var(--t4-scale))]">
                {bowlers.map((bowler, index) => {
                  ...
                  return (
                    <div
                      key={`${name}-${index}`}
                      className={`${ROW_GRID} shrink-0 rounded-[calc(8px*var(--t4-scale))] border border-white/15 px-[calc(18px*var(--t4-scale))] motion-safe:animate-soft-in motion-reduce:animate-none`}
                      style={{
                        ...fill,
                        minHeight: "calc(52px * var(--t4-scale))",
                        animationDelay: `${index * 60}ms`,
                      }}
                    >
                      <span className="truncate text-left text-[calc(22px*var(--t4-scale))] font-bold uppercase leading-[1.1] tracking-[calc(0.8px*var(--t4-scale))] text-[#f8fafc]">
                        {name}
                      </span>
                      <span className="text-center text-[calc(24px*var(--t4-scale))] font-bold tabular-nums leading-[1.1] text-[#f8fafc]">
                        {bowler.overs ?? "0.0"}
                      </span>
                      <span className="text-center text-[calc(24px*var(--t4-scale))] font-bold tabular-nums leading-[1.1] text-[#f8fafc]">
                        {bowler.dots ?? 0}
            ...
            {fallOfWickets ? (
              <div
                className="flex w-full shrink-0 items-center rounded-[calc(8px*var(--t4-scale))] bg-[linear-gradient(165deg,#ffffff_0%,#ffffff_58%,#f4f8fd_82%,#e3eef9_100%)] px-[calc(22px*var(--t4-scale))] py-[calc(12px*var(--t4-scale))] shadow-[0_calc(8px*var(--t4-scale))_calc(24px*var(--t4-scale))_rgba(0,0,0,0.3),inset_0_0_0_1px_rgba(255,255,255,0.15)]"
                style={{ minHeight: "calc(52px * var(--t4-scale))" }}
              >
                <span className="text-[calc(24px*var(--t4-scale))] font-bold uppercase leading-[1.1] tracking-[calc(1px*var(--t4-scale))] text-[#0f2847]">
