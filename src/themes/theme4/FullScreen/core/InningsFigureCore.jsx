...
/** Innings figures — 2×2 grid on NeedTarget shell (Theme 3 height, Theme 4 look). */
  ...
  return (
    <FullScreenPageShell>
      ...
      >
        ...
        >
          <div
            className={`relative flex ${NEED_FS_CARD_MIN_H} w-full flex-col items-center justify-center rounded-[calc(14px*var(--t4-scale))] border border-white/20 px-[calc(64px*var(--t4-scale))] py-[calc(48px*var(--t4-scale))] shadow-[0_0_calc(40px*var(--t4-scale))_rgba(0,0,0,0.35)]`}
            style={cardStyle}
          >
