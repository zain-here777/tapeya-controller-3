        ...
        >
          <div className="relative z-[1] flex min-w-0 flex-1 flex-col">
            <div className="flex h-[var(--t4-bar-row-short)] shrink-0 items-center justify-between gap-x-[calc(24px*var(--t4-scale))] px-[calc(28px*var(--t4-scale))]">
              <span className="motion-safe:animate-soft-in motion-reduce:animate-none flex-none whitespace-nowrap text-[calc(28px*var(--t4-scale))] font-bold uppercase leading-[1.05] tracking-[calc(0.8px*var(--t4-scale))] text-[#f8fafc]">
                {name}
              </span>

              {tournament ? (
                <span className="motion-safe:animate-soft-in motion-reduce:animate-none min-w-0 truncate text-right text-[calc(28px*var(--t4-scale))] font-bold uppercase leading-[1.05] tracking-[calc(0.8px*var(--t4-scale))] text-[#f8fafc]" style={{ animationDelay: "70ms" }}>
                  {tournament}
                </span>
              ) : null}
            </div>
            ...
            {stats.length ? (
              <div className="flex h-[var(--t4-bar-row-tall)] min-h-0 flex-1 items-center justify-center border-t border-white/25 px-[calc(28px*var(--t4-scale))]">
                <div className="flex items-end gap-[calc(36px*var(--t4-scale))]">
                  {stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="flex flex-col items-center gap-[calc(6px*var(--t4-scale))] leading-none text-[#f8fafc]"
                    >
                      <span className="whitespace-nowrap text-[calc(18px*var(--t4-scale))] font-bold uppercase leading-none tracking-[calc(1px*var(--t4-scale))]">
                        {stat.label}
                      </span>
                      <span className="whitespace-nowrap text-[calc(32px*var(--t4-scale))] font-bold tabular-nums leading-none">
                        {stat.value}
                      </span>
                    </div>
                  ))}
