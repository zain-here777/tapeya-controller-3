...
export default function MatchFSCore({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex h-full w-full items-center justify-center gap-[calc(16px*var(--t4-scale))] box-border px-[calc(48px*var(--t4-scale))] py-[calc(40px*var(--t4-scale))] motion-safe:animate-soft-in motion-reduce:animate-none">
        <div className="relative flex h-full min-h-0 w-[min(42%,calc(620px*var(--t4-scale)))] shrink-0 items-center justify-center overflow-hidden">
          {photoUrl ? (
            ...
            <div className="flex h-full w-full items-center justify-center">
              <span className="text-[calc(80px*var(--t4-scale))] font-extrabold uppercase leading-[0.95] tracking-[calc(1.5px*var(--t4-scale))] text-white/40">
                {(lastName || "?").slice(0, 1)}
              </span>
            </div>
          )}
        ...
        {stats.length ? (
          <div className="flex h-full max-h-[calc(720px*var(--t4-scale))] w-[calc(168px*var(--t4-scale))] shrink-0 flex-col items-stretch justify-stretch gap-[calc(8px*var(--t4-scale))]">
            {stats.map((stat, index) => (
              <div
                key={stat.label}
                className="flex min-h-0 flex-[1_1_0%] flex-col items-center justify-center gap-[calc(6px*var(--t4-scale))] rounded-[calc(6px*var(--t4-scale))] border border-[var(--t4-divider)] px-[calc(12px*var(--t4-scale))] py-[calc(8px*var(--t4-scale))] leading-none motion-safe:animate-soft-in motion-reduce:animate-none"
                style={{
                  backgroundColor: teamColor,
                  animationDelay: `${120 + index * 60}ms`,
                }}
              >
                <span className="whitespace-nowrap text-[calc(18px*var(--t4-scale))] font-bold uppercase leading-none tracking-[calc(1px*var(--t4-scale))] text-[#f8fafc]">
                  {stat.label}
                </span>
                <span className="text-[calc(36px*var(--t4-scale))] font-extrabold tabular-nums leading-none text-[#f8fafc]">
                  {stat.value}
                </span>
              </div>
            ))}
        ...
        <div className="flex w-[min(40%,calc(480px*var(--t4-scale)))] min-w-0 shrink-0 flex-col items-start justify-center gap-[calc(28px*var(--t4-scale))]">
          ...
          >
            <div className="flex flex-col gap-[calc(8px*var(--t4-scale))] leading-none">
              {firstName ? (
                <span className="text-[calc(34px*var(--t4-scale))] font-semibold uppercase leading-[1.05] tracking-[calc(2px*var(--t4-scale))] text-[#f8fafc]">
                  {firstName}
                </span>
              ) : null}
            ...
            <div className="flex flex-col gap-[calc(10px*var(--t4-scale))]">
              {teamCode ? (
                <span className="text-[calc(22px*var(--t4-scale))] font-bold uppercase leading-[1.1] tracking-[calc(2px*var(--t4-scale))] text-[#7dd3fc]">
                  {teamCode}
                </span>
              ) : null}
              {role ? (
                <span className="text-[calc(30px*var(--t4-scale))] font-bold uppercase leading-[1.15] tracking-[calc(1.2px*var(--t4-scale))] text-[#f8fafc]">
                  {role}
                </span>
              ) : null}
              {subtitle ? (
                <span className="text-[calc(22px*var(--t4-scale))] font-medium leading-[1.2] tracking-[calc(0.4px*var(--t4-scale))] text-[#f8fafc]/[0.72]">
                  {subtitle}
                </span>
              ) : null}
            </div>
