...
export default function TapeyaPromoCopy({
  ...
  return (
    <div className="relative z-[1] flex min-w-0 flex-1 flex-col">
      <div className="flex h-[calc(48px*var(--t4-scale))] shrink-0 items-center px-[calc(28px*var(--t4-scale))]">
      ...
      {site ? (
        <div className="flex min-h-0 flex-1 items-center border-t border-[var(--t4-divider)] px-[calc(28px*var(--t4-scale))]">
          <span
