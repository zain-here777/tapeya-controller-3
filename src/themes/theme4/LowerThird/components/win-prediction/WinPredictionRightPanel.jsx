...
/**
 * Theme 4 right panel for Win Prediction — title/stat columns + bowling-side team code.
  ...
  return (
    ...
    >
      <Last30BallsCard
        ...
        stats={stats}
        statLabelClassName="whitespace-nowrap text-[calc(28px*var(--t4-scale))] font-bold uppercase tracking-wide"
