...
/**
 * Theme 4 Tournament Name center — tournament title + optional venue row.
 *
 * @param {Object} props
...
export default function TournamentNameContent({ tournament, venue }) {
  return (
    <div className="relative z-[1] flex min-w-0 flex-1 flex-col">
      <div className="flex min-h-0 flex-1 items-center justify-center px-[calc(28px*var(--t4-scale))]">
        <span className="text-center text-[calc(36px*var(--t4-scale))] font-bold uppercase leading-none tracking-[calc(2px*var(--t4-scale))] text-white">
          {tournament}
        </span>
      </div>
