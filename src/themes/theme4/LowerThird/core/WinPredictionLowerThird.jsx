...
import WinPredictionRightPanel from "../components/win-prediction/WinPredictionRightPanel.jsx";

/**
 * Theme 4 Win Prediction lower third — Default shell without CRR;
 * right panel shows WIN PREDICTION + team percentages (batting-side color).
 *
 * @param {Object} props
 ...
 */
export default function WinPredictionLowerThird({
  match,
  baseConfig,
