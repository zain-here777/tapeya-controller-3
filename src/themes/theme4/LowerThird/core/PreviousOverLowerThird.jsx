...
/**
 * Theme 4 Previous Over lower third — ThisOver shell with "Last over X runs".
 *
 * @param {Object} props
 ...
 */
export default function PreviousOverLowerThird({
  match,
  baseConfig,
  ...
  const showLastOverSummary = config.bowlerPanel?.showLastOverSummary === true;
