...
/**
 * Theme 4 FOW lower third — team left, title right, wicket stacks centered on the bar.
 *
 * @param {Object} props
      ...
      <div className="relative flex h-[var(--t4-bar-height)] w-full items-stretch overflow-hidden shadow-[0_-2px_10px_rgba(0,0,0,0.12)]">
        ...
        <div className="relative min-w-0 flex-1" style={{ backgroundColor }}>
          ...
          <div className="relative z-10 flex h-full items-stretch">
            ...
            <div className="ml-auto flex h-full shrink-0 items-center pr-[calc(40px*var(--t4-scale))]">
              <span className="whitespace-nowrap text-[calc(28px*var(--t4-scale))] font-bold tracking-wide text-white">
                {title}
              </span>
            </div>
          </div>
        ...
        <div
          className="w-[calc(12px*var(--t4-scale))] shrink-0 self-stretch"
