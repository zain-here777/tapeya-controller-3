...
/**
 * MatchFS — full-screen batsman match graphic.
 * NameFS shell: portrait | vertical stats | logo + identity card.
 *
 * @param {Object} props
...
export default function MatchFSCore({
  ...
  return (
    ...
    >
      ...
      <div className="name-fs-inner match-fs-inner">
        ...
        {stats.length ? (
          <div className="match-fs-stats-col">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className={`match-fs-stat-block ${statBlockBg}`}
              >
        ...
        <div className="name-fs-info match-fs-info">
